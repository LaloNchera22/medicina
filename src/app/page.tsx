            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative hidden lg:block">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border-8 border-white dark:border-slate-800">
                  <img alt="Salud Digital" className="w-full aspect-[4/3] object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD8L_NpuZmOqlGTYod0UUjqvwibsfVzwNwQG4ENARhwk11VLKFUaRHAm17btaR7q1K4Ksx1Ol0L-lTY1-GHAH123ReeYVqb_QOFaqA3KH7INXV5BqGsRNEJRsyu12K5hkL-q60RKJd0rfjU5G-m9GJ5Vwm0eNXZ2gz0RhirknZhHnv6z8LNNpjX_MDQInc_TpAw7ZX5NiUWy3sfA46NavjlKmQLOB9Sm1Q2q3sExdtNTVRJicl0d2u9wazKxovSFqf0OF3iqiSeuUa0"/>
                </div>
              </div>
            </div>
          </div>
